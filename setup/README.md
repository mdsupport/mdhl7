...
3. Copy and update [3.mdhl7.env.sample](./3.mdhl7.env.sample) to the dotenv subdirectory of *home* of the user that will run these background jobs (example *//home/emrsys/dotenv/mdhl7.env*).<br>This utility does not use any of OpenEMR standard sql.inc or sqlconf.php files to get database login information.
